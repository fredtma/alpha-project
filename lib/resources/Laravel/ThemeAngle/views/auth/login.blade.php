...
<table style="width:100%">
    <tr>
        ...
        <td class="text-center" width="80%"><p style="font-size:18px;">Sign In</p></td>
        <td class="text-right" width="10%"><a href="{{url('/')}}"><p style="font-size:20px;"><i class="fa fa-home"></i></p></a></td>
    </tr>
</table> 
@if($errors->any())
