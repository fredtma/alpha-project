            ...
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading" style="font-size:18px;">_Model_s</div>
                    ...
                    <table id="datatable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter data-sort="false">
                        ...
                        <tr class="gradeX">
                            ...
                            <td data-sort-ignore="true" class="right">
                                <a href="{{url('_item_/'.$_item_->id)}}"><em class="icon-menu tableactions"></em>&nbsp;</a>
                                <a href="{{url('_item_/'.$_item_->id.'/edit')}}"><em class="icon-note tableactions"></em>&nbsp;</a>
                                <a href="#"><em class="icon-trash tableactions deletemodal" data-token="{{ csrf_token() }}" data-id="{{ $_item_->id }}"></em>&nbsp;</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
